...
void* solutionWriterThread(void* arg) {
	...
	float stageHeight = 0.0375; // the height of the stage (work great to set a little bit above the surface)   0.0355f;  0.031f; 
	...
	float velocity = 0.1f;					// maximum velocity in meter/second   0.05
	...
	////TEST 2 particles cross each other
	////bottle

	//initialPositions.push_back(glm::vec3(0.f, 0.02f, centreHeight + 0.03f)); initialPositions.push_back(glm::vec3(0.0f, -0.02f, centreHeight+0.0f));
	...
	//targetPositions.push_back(glm::vec3(0.f, -0.02f, centreHeight + 0.03f)); targetPositions.push_back(glm::vec3(0.f, 0.02f, centreHeight + 0.0f));
	//
	...
	//	paths[i].addWayPoint(0, initialPositions[i].x, initialPositions[i].y, initialPositions[i].z);
	//}
	//targetPositions.push_back(glm::vec3(0.0175f, 0.0175f, centreHeight)); //targetPositions.push_back(glm::vec3(0.0175f, -0.0175f, centreHeight));
	////targetPositions.push_back(glm::vec3(-0.0175f, 0.0175f, centreHeight)); targetPositions.push_back(glm::vec3(-0.0175f, -0.0175f, centreHeight));

	/*targetPositions.push_back(glm::vec3(0.0f, 0.0175f, centreHeight+ 0.0175f)); targetPositions.push_back(glm::vec3(0.0f, -0.0175f, centreHeight+0.0175f));
	targetPositions.push_back(glm::vec3(0.0f, 0.0175f, centreHeight-0.0175f)); targetPositions.push_back(glm::vec3(0.0f, -0.0175f, centreHeight-0.0175f));*/
...
//    targetPositions.push_back(glm::vec3(0.02f, 0.03f, centreHeight + 0.015f)); targetPositions.push_back(glm::vec3(0.02f, -0.03f, centreHeight + 0.045f));
  ...
  //    //TEST 7 4-up 4-down
	...
	std::vector<AgentPath> returnPaths = setPaths(planner, targetPositions, initialPositions, size, velocity, false, true);

	std::string TestName = "8_circle_to_cube";
